    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('open_date') ? 'is-invalid' : '' }}" type="text" name="open_date" id="open_date" value="{{ old('open_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_date') ? 'is-invalid' : '' }}" type="text" name="last_date" id="last_date" value="{{ old('last_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('payment_end_date') ? 'is-invalid' : '' }}" type="text" name="payment_end_date" id="payment_end_date" value="{{ old('payment_end_date') }}">
