...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.otherDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.other-details.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fellowship_undergraduate') ? 'is-invalid' : '' }}" type="text" name="fellowship_undergraduate" id="fellowship_undergraduate" value="{{ old('fellowship_undergraduate', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fellowship_graduate') ? 'is-invalid' : '' }}" type="text" name="fellowship_graduate" id="fellowship_graduate" value="{{ old('fellowship_graduate', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fellowship_postgraduate') ? 'is-invalid' : '' }}" type="text" name="fellowship_postgraduate" id="fellowship_postgraduate" value="{{ old('fellowship_postgraduate', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phd_thesis_title') ? 'is-invalid' : '' }}" type="text" name="phd_thesis_title" id="phd_thesis_title" value="{{ old('phd_thesis_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_phd_awarded') ? 'is-invalid' : '' }}" type="number" name="research_phd_awarded" id="research_phd_awarded" value="{{ old('research_phd_awarded', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_phd_thesis') ? 'is-invalid' : '' }}" type="number" name="research_phd_thesis" id="research_phd_thesis" value="{{ old('research_phd_thesis', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_phd_total_scholars') ? 'is-invalid' : '' }}" type="number" name="research_phd_total_scholars" id="research_phd_total_scholars" value="{{ old('research_phd_total_scholars', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_mphil_awarded') ? 'is-invalid' : '' }}" type="number" name="research_mphil_awarded" id="research_mphil_awarded" value="{{ old('research_mphil_awarded', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_mphil_thesis') ? 'is-invalid' : '' }}" type="number" name="research_mphil_thesis" id="research_mphil_thesis" value="{{ old('research_mphil_thesis', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_mphil_total_scholars') ? 'is-invalid' : '' }}" type="number" name="research_mphil_total_scholars" id="research_mphil_total_scholars" value="{{ old('research_mphil_total_scholars', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_other_awarded') ? 'is-invalid' : '' }}" type="number" name="research_other_awarded" id="research_other_awarded" value="{{ old('research_other_awarded', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_other_thesis') ? 'is-invalid' : '' }}" type="number" name="research_other_thesis" id="research_other_thesis" value="{{ old('research_other_thesis', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_other_total_scholars') ? 'is-invalid' : '' }}" type="number" name="research_other_total_scholars" id="research_other_total_scholars" value="{{ old('research_other_total_scholars', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('eminent_scholar') ? 'is-invalid' : '' }}" name="eminent_scholar" id="eminent_scholar">{{ old('eminent_scholar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('contribution_to_knowledge') ? 'is-invalid' : '' }}" name="contribution_to_knowledge" id="contribution_to_knowledge">{{ old('contribution_to_knowledge') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('engaged_in_research') ? 'is-invalid' : '' }}" name="engaged_in_research" id="engaged_in_research">{{ old('engaged_in_research') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('industry_experience') ? 'is-invalid' : '' }}" name="industry_experience" id="industry_experience">{{ old('industry_experience') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_pay_level') ? 'is-invalid' : '' }}" type="text" name="current_pay_level" id="current_pay_level" value="{{ old('current_pay_level', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_pay_range') ? 'is-invalid' : '' }}" type="text" name="current_pay_range" id="current_pay_range" value="{{ old('current_pay_range', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_pay_band') ? 'is-invalid' : '' }}" type="text" name="current_pay_band" id="current_pay_band" value="{{ old('current_pay_band', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_grade_pay') ? 'is-invalid' : '' }}" type="text" name="current_grade_pay" id="current_grade_pay" value="{{ old('current_grade_pay', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_basic_pay_old') ? 'is-invalid' : '' }}" type="text" name="current_basic_pay_old" id="current_basic_pay_old" value="{{ old('current_basic_pay_old', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_allowances') ? 'is-invalid' : '' }}" type="text" name="current_allowances" id="current_allowances" value="{{ old('current_allowances', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_allowances_total') ? 'is-invalid' : '' }}" type="text" name="current_allowances_total" id="current_allowances_total" value="{{ old('current_allowances_total', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('increment_date') ? 'is-invalid' : '' }}" type="text" name="increment_date" id="increment_date" value="{{ old('increment_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('minimum_initial_pay') ? 'is-invalid' : '' }}" name="minimum_initial_pay" id="minimum_initial_pay">{{ old('minimum_initial_pay') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('joining_time') ? 'is-invalid' : '' }}" type="text" name="joining_time" id="joining_time" value="{{ old('joining_time', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('books_published') ? 'is-invalid' : '' }}" type="number" name="books_published" id="books_published" value="{{ old('books_published', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('books_accepted') ? 'is-invalid' : '' }}" type="number" name="books_accepted" id="books_accepted" value="{{ old('books_accepted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('papers_published') ? 'is-invalid' : '' }}" type="number" name="papers_published" id="papers_published" value="{{ old('papers_published', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('papers_accepted') ? 'is-invalid' : '' }}" type="number" name="papers_accepted" id="papers_accepted" value="{{ old('papers_accepted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('articles_published') ? 'is-invalid' : '' }}" type="number" name="articles_published" id="articles_published" value="{{ old('articles_published', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('articles_accepted') ? 'is-invalid' : '' }}" type="number" name="articles_accepted" id="articles_accepted" value="{{ old('articles_accepted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('papers_read_published') ? 'is-invalid' : '' }}" type="number" name="papers_read_published" id="papers_read_published" value="{{ old('papers_read_published', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('papers_read_accepted') ? 'is-invalid' : '' }}" type="number" name="papers_read_accepted" id="papers_read_accepted" value="{{ old('papers_read_accepted', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eca_university_administration') ? 'is-invalid' : '' }}" type="text" name="eca_university_administration" id="eca_university_administration" value="{{ old('eca_university_administration', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eca_student') ? 'is-invalid' : '' }}" type="text" name="eca_student" id="eca_student" value="{{ old('eca_student', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eca_residential_student') ? 'is-invalid' : '' }}" type="text" name="eca_residential_student" id="eca_residential_student" value="{{ old('eca_residential_student', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eca_cultural') ? 'is-invalid' : '' }}" type="text" name="eca_cultural" id="eca_cultural" value="{{ old('eca_cultural', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('relevant_work') ? 'is-invalid' : '' }}" name="relevant_work" id="relevant_work">{{ old('relevant_work') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('previous_applications') ? 'is-invalid' : '' }}" type="text" name="previous_applications" id="previous_applications" value="{{ old('previous_applications', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('testimonial_1') ? 'is-invalid' : '' }}" type="text" name="testimonial_1" id="testimonial_1" value="{{ old('testimonial_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('testimonial_2') ? 'is-invalid' : '' }}" type="text" name="testimonial_2" id="testimonial_2" value="{{ old('testimonial_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('testimonial_3') ? 'is-invalid' : '' }}" type="text" name="testimonial_3" id="testimonial_3" value="{{ old('testimonial_3', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remark_essential_qualification') ? 'is-invalid' : '' }}" name="remark_essential_qualification" id="remark_essential_qualification">{{ old('remark_essential_qualification') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remark_desirable_qualification') ? 'is-invalid' : '' }}" name="remark_desirable_qualification" id="remark_desirable_qualification">{{ old('remark_desirable_qualification') }}</textarea>
