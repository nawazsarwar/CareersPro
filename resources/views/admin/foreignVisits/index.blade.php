                        ...
                        <tr data-entry-id="{{ $foreignVisit->id }}">
                            ...
                            <td>
                                @can('foreign_visit_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.foreign-visits.show', $foreignVisit->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('foreign_visit_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.foreign-visits.edit', $foreignVisit->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('foreign_visit_delete')
                                    <form action="{{ route('admin.foreign-visits.destroy', $foreignVisit->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
