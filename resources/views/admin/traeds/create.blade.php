...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.traeds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teaching_at_bachelors_level_in_years') ? 'is-invalid' : '' }}" type="number" name="teaching_at_bachelors_level_in_years" id="teaching_at_bachelors_level_in_years" value="{{ old('teaching_at_bachelors_level_in_years', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teaching_at_masters_level_in_years') ? 'is-invalid' : '' }}" type="number" name="teaching_at_masters_level_in_years" id="teaching_at_masters_level_in_years" value="{{ old('teaching_at_masters_level_in_years', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_at_masters_level_in_years') ? 'is-invalid' : '' }}" type="number" name="research_at_masters_level_in_years" id="research_at_masters_level_in_years" value="{{ old('research_at_masters_level_in_years', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('research_at_post_doctorals_level_in_years') ? 'is-invalid' : '' }}" type="number" name="research_at_post_doctorals_level_in_years" id="research_at_post_doctorals_level_in_years" value="{{ old('research_at_post_doctorals_level_in_years', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('experience_in_educational_administration_in_years') ? 'is-invalid' : '' }}" type="number" name="experience_in_educational_administration_in_years" id="experience_in_educational_administration_in_years" value="{{ old('experience_in_educational_administration_in_years', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('any_other_administrative_experience_in_years') ? 'is-invalid' : '' }}" type="number" name="any_other_administrative_experience_in_years" id="any_other_administrative_experience_in_years" value="{{ old('any_other_administrative_experience_in_years', '') }}" step="1">
