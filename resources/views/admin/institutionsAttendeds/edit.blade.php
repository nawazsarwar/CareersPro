...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.institutions-attendeds.update", [$institutionsAttended->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_of_school') ? 'is-invalid' : '' }}" type="text" name="name_of_school" id="name_of_school" value="{{ old('name_of_school', $institutionsAttended->name_of_school) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_of_college') ? 'is-invalid' : '' }}" type="text" name="name_of_college" id="name_of_college" value="{{ old('name_of_college', $institutionsAttended->name_of_college) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_joining') ? 'is-invalid' : '' }}" type="number" name="year_of_joining" id="year_of_joining" value="{{ old('year_of_joining', $institutionsAttended->year_of_joining) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_leaving') ? 'is-invalid' : '' }}" type="number" name="year_of_leaving" id="year_of_leaving" value="{{ old('year_of_leaving', $institutionsAttended->year_of_leaving) }}" step="1" required>
