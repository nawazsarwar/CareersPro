    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.provinces.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_3166_2_in') ? 'is-invalid' : '' }}" type="text" name="iso_3166_2_in" id="iso_3166_2_in" value="{{ old('iso_3166_2_in', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_code') ? 'is-invalid' : '' }}" type="text" name="vehicle_code" id="vehicle_code" value="{{ old('vehicle_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('largest_city') ? 'is-invalid' : '' }}" type="text" name="largest_city" id="largest_city" value="{{ old('largest_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statehood') ? 'is-invalid' : '' }}" type="number" name="statehood" id="statehood" value="{{ old('statehood', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_languages') ? 'is-invalid' : '' }}" type="text" name="official_languages" id="official_languages" value="{{ old('official_languages', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_official_languages') ? 'is-invalid' : '' }}" type="text" name="additional_official_languages" id="additional_official_languages" value="{{ old('additional_official_languages', '') }}">
