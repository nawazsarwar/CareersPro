    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.academic-qualifications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percentage') ? 'is-invalid' : '' }}" type="number" name="percentage" id="percentage" value="{{ old('percentage', '') }}" step="0.01" max="100">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subjects') ? 'is-invalid' : '' }}" type="text" name="subjects" id="subjects" value="{{ old('subjects', '') }}" required>
