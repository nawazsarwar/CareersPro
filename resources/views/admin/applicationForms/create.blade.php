...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-forms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('random_no') ? 'is-invalid' : '' }}" type="number" name="random_no" id="random_no" value="{{ old('random_no', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('advertisement_title') ? 'is-invalid' : '' }}" type="text" name="advertisement_title" id="advertisement_title" value="{{ old('advertisement_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_serial_no') ? 'is-invalid' : '' }}" type="text" name="post_serial_no" id="post_serial_no" value="{{ old('post_serial_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_title') ? 'is-invalid' : '' }}" type="text" name="post_title" id="post_title" value="{{ old('post_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correspondence_address') ? 'is-invalid' : '' }}" type="text" name="correspondence_address" id="correspondence_address" value="{{ old('correspondence_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domicile_district') ? 'is-invalid' : '' }}" type="text" name="domicile_district" id="domicile_district" value="{{ old('domicile_district', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('basic_details') ? 'is-invalid' : '' }}" name="basic_details" id="basic_details">{{ old('basic_details') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_details') ? 'is-invalid' : '' }}" name="additional_details" id="additional_details">{{ old('additional_details') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('review') ? 'is-invalid' : '' }}" type="number" name="review" id="review" value="{{ old('review', '1') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('submitted') ? 'is-invalid' : '' }}" type="number" name="submitted" id="submitted" value="{{ old('submitted', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('scrutiny_remark') ? 'is-invalid' : '' }}" name="scrutiny_remark" id="scrutiny_remark">{{ old('scrutiny_remark') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('eligibility_remark') ? 'is-invalid' : '' }}" name="eligibility_remark" id="eligibility_remark">{{ old('eligibility_remark') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('eligibility_updated_at') ? 'is-invalid' : '' }}" type="text" name="eligibility_updated_at" id="eligibility_updated_at" value="{{ old('eligibility_updated_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_uid') ? 'is-invalid' : '' }}" type="text" name="order_uid" id="order_uid" value="{{ old('order_uid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('admitcard_downloaded_at') ? 'is-invalid' : '' }}" type="text" name="admitcard_downloaded_at" id="admitcard_downloaded_at" value="{{ old('admitcard_downloaded_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('interview_letter_downloaded_at') ? 'is-invalid' : '' }}" type="text" name="interview_letter_downloaded_at" id="interview_letter_downloaded_at" value="{{ old('interview_letter_downloaded_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('centre_name') ? 'is-invalid' : '' }}" type="text" name="centre_name" id="centre_name" value="{{ old('centre_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('centre_code') ? 'is-invalid' : '' }}" type="text" name="centre_code" id="centre_code" value="{{ old('centre_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('centre_address') ? 'is-invalid' : '' }}" type="text" name="centre_address" id="centre_address" value="{{ old('centre_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('centre_city') ? 'is-invalid' : '' }}" type="text" name="centre_city" id="centre_city" value="{{ old('centre_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seat_no') ? 'is-invalid' : '' }}" type="text" name="seat_no" id="seat_no" value="{{ old('seat_no', '') }}">
