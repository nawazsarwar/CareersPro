    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.advertisements.update", [$advertisement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $advertisement->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $advertisement->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dated') ? 'is-invalid' : '' }}" type="text" name="dated" id="dated" value="{{ old('dated', $advertisement->dated) }}">
                @if($errors->has('dated'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('advertisement_url') ? 'is-invalid' : '' }}" type="text" name="advertisement_url" id="advertisement_url" value="{{ old('advertisement_url', $advertisement->advertisement_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_fee') ? 'is-invalid' : '' }}" type="number" name="default_fee" id="default_fee" value="{{ old('default_fee', $advertisement->default_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('default_opening_date') ? 'is-invalid' : '' }}" type="text" name="default_opening_date" id="default_opening_date" value="{{ old('default_opening_date', $advertisement->default_opening_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('default_closing_date') ? 'is-invalid' : '' }}" type="text" name="default_closing_date" id="default_closing_date" value="{{ old('default_closing_date', $advertisement->default_closing_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('default_payment_closing_date') ? 'is-invalid' : '' }}" type="text" name="default_payment_closing_date" id="default_payment_closing_date" value="{{ old('default_payment_closing_date', $advertisement->default_payment_closing_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $advertisement->remarks) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('approved_at') ? 'is-invalid' : '' }}" type="text" name="approved_at" id="approved_at" value="{{ old('approved_at', $advertisement->approved_at) }}">
