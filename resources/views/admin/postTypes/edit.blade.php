    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.post-types.update", [$postType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $postType->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pdf_template') ? 'is-invalid' : '' }}" type="text" name="pdf_template" id="pdf_template" value="{{ old('pdf_template', $postType->pdf_template) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('admit_card_template') ? 'is-invalid' : '' }}" type="text" name="admit_card_template" id="admit_card_template" value="{{ old('admit_card_template', $postType->admit_card_template) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interview_letter_template') ? 'is-invalid' : '' }}" type="text" name="interview_letter_template" id="interview_letter_template" value="{{ old('interview_letter_template', $postType->interview_letter_template) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('submission_venue') ? 'is-invalid' : '' }}" type="text" name="submission_venue" id="submission_venue" value="{{ old('submission_venue', $postType->submission_venue) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $postType->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $postType->remarks) }}</textarea>
