    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.profiles.update", [$profile->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $profile->middle_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $profile->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_name') ? 'is-invalid' : '' }}" type="text" name="spouse_name" id="spouse_name" value="{{ old('spouse_name', $profile->spouse_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fathers_name') ? 'is-invalid' : '' }}" type="text" name="fathers_name" id="fathers_name" value="{{ old('fathers_name', $profile->fathers_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mothers_name') ? 'is-invalid' : '' }}" type="text" name="mothers_name" id="mothers_name" value="{{ old('mothers_name', $profile->mothers_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $profile->dob) }}">
                @if($errors->has('dob'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('mobile_verified_at') ? 'is-invalid' : '' }}" type="text" name="mobile_verified_at" id="mobile_verified_at" value="{{ old('mobile_verified_at', $profile->mobile_verified_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternate_mobile') ? 'is-invalid' : '' }}" type="text" name="alternate_mobile" id="alternate_mobile" value="{{ old('alternate_mobile', $profile->alternate_mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disability_percent') ? 'is-invalid' : '' }}" type="number" name="disability_percent" id="disability_percent" value="{{ old('disability_percent', $profile->disability_percent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aadhaar_no') ? 'is-invalid' : '' }}" type="text" name="aadhaar_no" id="aadhaar_no" value="{{ old('aadhaar_no', $profile->aadhaar_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_caste') ? 'is-invalid' : '' }}" type="text" name="sub_caste" id="sub_caste" value="{{ old('sub_caste', $profile->sub_caste) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity_marks') ? 'is-invalid' : '' }}" type="text" name="identity_marks" id="identity_marks" value="{{ old('identity_marks', $profile->identity_marks) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks">{{ old('remarks', $profile->remarks) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('verified') ? 'is-invalid' : '' }}" type="number" name="verified" id="verified" value="{{ old('verified', $profile->verified) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('locked') ? 'is-invalid' : '' }}" type="number" name="locked" id="locked" value="{{ old('locked', $profile->locked) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conviction_reason') ? 'is-invalid' : '' }}" type="text" name="conviction_reason" id="conviction_reason" value="{{ old('conviction_reason', $profile->conviction_reason) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('debarred_reason') ? 'is-invalid' : '' }}" type="text" name="debarred_reason" id="debarred_reason" value="{{ old('debarred_reason', $profile->debarred_reason) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vigilance_reason') ? 'is-invalid' : '' }}" type="text" name="vigilance_reason" id="vigilance_reason" value="{{ old('vigilance_reason', $profile->vigilance_reason) }}">
