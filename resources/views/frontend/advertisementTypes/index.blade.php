        ...
        <div class="col-md-12">
            @can('advertisement_type_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.advertisement-types.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $advertisementType->id }}">
                                        ...
                                        <td>
                                            @can('advertisement_type_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.advertisement-types.show', $advertisementType->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('advertisement_type_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.advertisement-types.edit', $advertisementType->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
