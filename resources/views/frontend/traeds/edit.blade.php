    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.traeds.update", [$traed->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="teaching_at_bachelors_level_in_years" id="teaching_at_bachelors_level_in_years" value="{{ old('teaching_at_bachelors_level_in_years', $traed->teaching_at_bachelors_level_in_years) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="teaching_at_masters_level_in_years" id="teaching_at_masters_level_in_years" value="{{ old('teaching_at_masters_level_in_years', $traed->teaching_at_masters_level_in_years) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="research_at_masters_level_in_years" id="research_at_masters_level_in_years" value="{{ old('research_at_masters_level_in_years', $traed->research_at_masters_level_in_years) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="research_at_post_doctorals_level_in_years" id="research_at_post_doctorals_level_in_years" value="{{ old('research_at_post_doctorals_level_in_years', $traed->research_at_post_doctorals_level_in_years) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="experience_in_educational_administration_in_years" id="experience_in_educational_administration_in_years" value="{{ old('experience_in_educational_administration_in_years', $traed->experience_in_educational_administration_in_years) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="any_other_administrative_experience_in_years" id="any_other_administrative_experience_in_years" value="{{ old('any_other_administrative_experience_in_years', $traed->any_other_administrative_experience_in_years) }}" step="1">
