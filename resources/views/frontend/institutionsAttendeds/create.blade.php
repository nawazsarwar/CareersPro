    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.institutions-attendeds.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name_of_school" id="name_of_school" value="{{ old('name_of_school', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name_of_college" id="name_of_college" value="{{ old('name_of_college', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="year_of_joining" id="year_of_joining" value="{{ old('year_of_joining', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="year_of_leaving" id="year_of_leaving" value="{{ old('year_of_leaving', '') }}" step="1" required>
