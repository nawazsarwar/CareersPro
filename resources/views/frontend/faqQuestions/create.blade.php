                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.faq-questions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-brand-500/10 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" name="question" id="question" required>{{ old('question') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-brand-500/10 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" name="answer" id="answer" required>{{ old('answer') }}</textarea>
