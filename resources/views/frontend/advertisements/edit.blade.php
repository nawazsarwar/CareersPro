                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.advertisements.update", [$advertisement->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="default_open_date" id="default_open_date" value="{{ old('default_open_date', $advertisement->default_open_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="default_end_date" id="default_end_date" value="{{ old('default_end_date', $advertisement->default_end_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="default_payment_end_date" id="default_payment_end_date" value="{{ old('default_payment_end_date', $advertisement->default_payment_end_date) }}">
