        ...
        <div class="col-md-12">
            @can('eligibility_test_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.eligibility-tests.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-EligibilityTest">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $eligibilityTest->id }}">
                                        ...
                                        <td>
                                            @can('eligibility_test_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.eligibility-tests.show', $eligibilityTest->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('eligibility_test_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.eligibility-tests.edit', $eligibilityTest->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
...
@endcan
  ...
  let table = $('.datatable-EligibilityTest:not(.ajaxTable)').DataTable({ buttons: dtButtons })
