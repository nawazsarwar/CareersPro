                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.profiles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="conviction_reason" id="conviction_reason">{{ old('conviction_reason') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="debarred_reason" id="debarred_reason">{{ old('debarred_reason') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="vigilance_reason" id="vigilance_reason">{{ old('vigilance_reason') }}</textarea>
