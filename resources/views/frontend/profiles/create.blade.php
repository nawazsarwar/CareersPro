                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.profiles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="mobile_verified_at" id="mobile_verified_at" value="{{ old('mobile_verified_at') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alternate_mobile" id="alternate_mobile" value="{{ old('alternate_mobile', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="verified" id="verified" value="{{ old('verified', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="locked" id="locked" value="{{ old('locked', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="conviction_reason" id="conviction_reason" value="{{ old('conviction_reason', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="debarred_reason" id="debarred_reason" value="{{ old('debarred_reason', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vigilance_reason" id="vigilance_reason" value="{{ old('vigilance_reason', '') }}">
