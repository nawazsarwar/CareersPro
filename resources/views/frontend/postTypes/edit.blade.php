                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.post-types.update", [$postType->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="admit_card_template" id="admit_card_template" value="{{ old('admit_card_template', $postType->admit_card_template) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="interview_letter_template" id="interview_letter_template" value="{{ old('interview_letter_template', $postType->interview_letter_template) }}">
