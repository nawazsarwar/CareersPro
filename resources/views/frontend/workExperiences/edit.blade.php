                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.work-experiences.update", [$workExperience->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="employer" id="employer" value="{{ old('employer', $workExperience->employer) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="designation" id="designation" value="{{ old('designation', $workExperience->designation) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="from" id="from" value="{{ old('from', $workExperience->from) }}" required>
                            @if($errors->has('from'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('from') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="to" id="to" value="{{ old('to', $workExperience->to) }}">
                            @if($errors->has('to'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="responsibilities" id="responsibilities" value="{{ old('responsibilities', $workExperience->responsibilities) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reason_for_leaving" id="reason_for_leaving" value="{{ old('reason_for_leaving', $workExperience->reason_for_leaving) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pay_band" id="pay_band" value="{{ old('pay_band', $workExperience->pay_band) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="basic_pay" id="basic_pay" value="{{ old('basic_pay', $workExperience->basic_pay) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gross_pay" id="gross_pay" value="{{ old('gross_pay', $workExperience->gross_pay) }}" required>
