    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.application-forms.update", [$applicationForm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="roll_no" id="roll_no" value="{{ old('roll_no', $applicationForm->roll_no) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="random_no" id="random_no" value="{{ old('random_no', $applicationForm->random_no) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="advertisement_title" id="advertisement_title" value="{{ old('advertisement_title', $applicationForm->advertisement_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_serial_no" id="post_serial_no" value="{{ old('post_serial_no', $applicationForm->post_serial_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_title" id="post_title" value="{{ old('post_title', $applicationForm->post_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $applicationForm->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $applicationForm->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="dob" id="dob" value="{{ old('dob', $applicationForm->dob) }}">
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $applicationForm->mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="disability_percent" id="disability_percent" value="{{ old('disability_percent', $applicationForm->disability_percent) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="aadhaar_no" id="aadhaar_no" value="{{ old('aadhaar_no', $applicationForm->aadhaar_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_caste" id="sub_caste" value="{{ old('sub_caste', $applicationForm->sub_caste) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="permanent_address" id="permanent_address" value="{{ old('permanent_address', $applicationForm->permanent_address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="correspondence_address" id="correspondence_address" value="{{ old('correspondence_address', $applicationForm->correspondence_address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="domicile_district" id="domicile_district" value="{{ old('domicile_district', $applicationForm->domicile_district) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="basic_details" id="basic_details">{{ old('basic_details', $applicationForm->basic_details) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="additional_details" id="additional_details">{{ old('additional_details', $applicationForm->additional_details) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $applicationForm->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $applicationForm->remarks) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="review" id="review" value="{{ old('review', $applicationForm->review) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="submitted" id="submitted" value="{{ old('submitted', $applicationForm->submitted) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="paid" id="paid" value="{{ old('paid', $applicationForm->paid) }}" step="1">
                            @if($errors->has('paid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('paid') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="scrutiny_remark" id="scrutiny_remark">{{ old('scrutiny_remark', $applicationForm->scrutiny_remark) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="eligibility_remark" id="eligibility_remark">{{ old('eligibility_remark', $applicationForm->eligibility_remark) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="eligibility_updated_at" id="eligibility_updated_at" value="{{ old('eligibility_updated_at', $applicationForm->eligibility_updated_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="order_uid" id="order_uid" value="{{ old('order_uid', $applicationForm->order_uid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="admitcard_downloaded_at" id="admitcard_downloaded_at" value="{{ old('admitcard_downloaded_at', $applicationForm->admitcard_downloaded_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="interview_letter_downloaded_at" id="interview_letter_downloaded_at" value="{{ old('interview_letter_downloaded_at', $applicationForm->interview_letter_downloaded_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="centre_name" id="centre_name" value="{{ old('centre_name', $applicationForm->centre_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="centre_code" id="centre_code" value="{{ old('centre_code', $applicationForm->centre_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="centre_address" id="centre_address" value="{{ old('centre_address', $applicationForm->centre_address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="centre_city" id="centre_city" value="{{ old('centre_city', $applicationForm->centre_city) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="room_no" id="room_no" value="{{ old('room_no', $applicationForm->room_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="seat_no" id="seat_no" value="{{ old('seat_no', $applicationForm->seat_no) }}">
