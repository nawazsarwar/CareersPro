                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.update", [$post->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="open_date" id="open_date" value="{{ old('open_date', $post->open_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_date" id="last_date" value="{{ old('last_date', $post->last_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="payment_last_date" id="payment_last_date" value="{{ old('payment_last_date', $post->payment_last_date) }}">
