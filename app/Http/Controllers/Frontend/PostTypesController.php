...
class PostTypesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.postTypes.index', compact('postTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.postTypes.create');
    }
    ...
    public function store(StorePostTypeRequest $request)
    {
        ...
        return redirect()->route('frontend.post-types.index');
    }
    ...
    public function edit(PostType $postType)
    {
        ...
        return view('frontend.postTypes.edit', compact('postType'));
    }
    ...
    public function show(PostType $postType)
    {
        ...
        return view('frontend.postTypes.show', compact('postType'));
    }
