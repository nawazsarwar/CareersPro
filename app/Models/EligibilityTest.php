...
class EligibilityTest extends Model
{
    ...
    protected $table = 'eligibility_tests';

    /** @var list<string> */
    protected $fillable = ['user_id', 'name', 'agency', 'subject', 'year', 'roll_no', 'certificate_no'];
     ...
     *
     * @param  Builder<EligibilityTest>  $query
     * @return Builder<EligibilityTest>
     */
