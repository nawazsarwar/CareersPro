...
use App\Http\Controllers\Admin\WorkExperiencesController as AdminWorkExperiencesController;
...
use App\Http\Controllers\Frontend\WorkExperiencesController as FrontendWorkExperiencesController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Employment History
    Route::delete('employment-histories/destroy', [AdminWorkExperiencesController::class, 'massDestroy'])->name('employment-histories.massDestroy');
    Route::resource('employment-histories', AdminWorkExperiencesController::class);
...
Route::group(['as' => 'frontend.', 'middleware' => ['auth']], function () {
    ...
    // Employment History
    Route::delete('employment-histories/destroy', [FrontendWorkExperiencesController::class, 'massDestroy'])->name('employment-histories.massDestroy');
    Route::resource('employment-histories', FrontendWorkExperiencesController::class);
